...
void IRsend::enableIRModulation(bool modulate) {
  // Toggles a boolean value that will enable or disable modulation on the
  // IR output

  this->modulate = modulate;
}

void IRsend::enableIRInvert(bool invert) {
  // Toggles a boolean value that will optionally invert the outgoing IR
  // signal
