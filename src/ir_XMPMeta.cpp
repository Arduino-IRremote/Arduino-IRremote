...
// on Mon Oct 23 11:47:44 CEST 2017
...
static inline unsigned int C1(unsigned int FF,
        unsigned int D,
        unsigned int S,
        unsigned int OEM,
        unsigned int T) {
...
static inline unsigned int C2(unsigned int FF,
        unsigned int D,
        unsigned int S,
        unsigned int OEM,
        unsigned int T) {
    return -(((((((S) + (((S) >> (4U)))) + (T)) + (FF)) + (((FF) >> (4U)))) + (((FF) >> (8U)))) + (((FF) >> (12U))));
}
 ...
 */
void IRsend::sendXMPMeta(unsigned int FF,
        unsigned int D,
        unsigned int S,
        unsigned int OEM) {
    ...
    bitField(instance, C1(FF, D, S, OEM, T), 4U);
    ...
    gap(instance, 13800);
    bitField(instance, S >> (4U), 4U);
    bitField(instance, C2(FF, D, S, OEM, T), 4U);
    bitField(instance, T, 4U);
    bitField(instance, S, 4U);
    bitField(instance, FF, 16U);
    flash(instance, 210);
    gap(instance, 80400);
}
